...
def valid(img_dir, gt_dir, valid_list):
    ...
    with tf.compat.v1.Session (config=cfg) as sess:
        tf.compat.v1.train.Saver().restore(sess=sess, save_path=tf.train.latest_checkpoint('/content/drive/MyDrive/DS-store/Det_train/pretrained/checkpoint'))
...
if __name__ == '__main__':
    valid('/content/drive/MyDrive/DS-store/Det_train/input_img', '/content/drive/MyDrive/DS-store/Det_train/input_gt', '/content/drive/MyDrive/DS-store/Det_train/valid.list')
